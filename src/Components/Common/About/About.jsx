    ...
    <div className="container-fluid pt-5">
      <div className="container">
        <div
          ...
          style={{ maxWidth: "600px" }} //  style prop
        >
          ...
          <div className="col-lg-5 mb-5 mb-lg-0" style={{ minHeight: "400px" }}>
            ...
            <div className="position-relative h-100">
              <img
                ...
                src="img/about.jpg"
                style={{ objectFit: "cover" }} //  style prop
                alt="About CakeZone" // Added alt attribute for accessibility
              />
            </div>
          </div>
            ...
            <div className="row g-5">
              <div className="col-sm-6">
                <div
                  ...
                  style={{ width: "90px", height: "90px" }} //  style prop
                >
